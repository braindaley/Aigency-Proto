...
export default function PropertyTaskPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      router.push('/settings/task-settings/property');
    } catch (error) {
    ...
    <div className="mx-auto max-w-[672px] px-4 py-8 md:py-12">
      <div className="flex justify-between items-center mb-8">
        <Button variant="ghost" asChild>
          <Link href="/settings/task-settings/property" className="flex items-center gap-2 text-sm font-medium text-muted-foreground">
